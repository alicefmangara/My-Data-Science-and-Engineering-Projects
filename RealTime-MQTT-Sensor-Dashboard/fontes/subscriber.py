...
MQTT_SERVER = "192.168.1.91" #specify the broker address, it can be IP of raspberry pi or simply localhost
MQTT_PATH = "srsa" #this is the name of topic, like temp
